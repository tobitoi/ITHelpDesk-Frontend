<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form>
        <el-form-item>
          <el-button type="success" icon="plus" v-if="hasPerm('user:add')" @click="showCreate">Create
          </el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="loading" border fit
      ...
      <el-table-column align="center" label="Role name" prop="roleName" width="150"></el-table-column>
      ...
      <el-table-column align="center" label="Menu & Permissions" width="420">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.roleName==adminName" type="success">All</el-tag>
          <div v-else>
      ...
      <el-table-column align="center" label="Action" width="220" v-if="hasPerm('role:update') ||hasPerm('role:delete') ">
        <template slot-scope="scope">
          <div v-if="scope.row.roleName!='administrator'">
            <el-button type="primary" icon="edit" @click="showUpdate(scope.$index)" v-if="hasPerm('role:update')">Update
            </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempRole" label-position="left" label-width="100px"
        ...
        <el-form-item label="Menu" required>
          ...
          <p style="color:#848484;">NOTE: The red permission is the required permission in the corresponding menu</p>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible = false">Cancel</el-button>
        <el-button v-if="dialogStatus=='create'" type="success" @click="createRole">Create</el-button>
        <el-button type="primary" v-else @click="updateRole">Update</el-button>
      </div>
    </el-dialog>
  </div>
</template>
